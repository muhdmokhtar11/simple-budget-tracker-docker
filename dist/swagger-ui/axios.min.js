...
!(function (e, t) {
  ...
  var ue,
    ...
    de = 'undefined' != typeof queueMicrotask ? queueMicrotask.bind(ee) : ('undefined' != typeof process && process.nextTick) || he,
    ve = {
      isArray: C,
      isArrayBuffer: F,
      isBuffer: function (e) {
        return null !== e && !U(e) && null !== e.constructor && !U(e.constructor) && D(e.constructor.isBuffer) && e.constructor.isBuffer(e);
      },
      isFormData: function (e) {
        ...
        return (
          ...
          (('function' == typeof FormData && e instanceof FormData) ||
            (D(e.append) && ('formdata' === (t = L(e)) || ('object' === t && D(e.toString) && '[object FormData]' === e.toString()))))
        );
      },
      ...
      merge: function e() {
        for (
          var t = (te(this) && this) || {},
            ...
            o = function (t, o) {
              var i = (r && Z(n, o)) || o;
              M(n[i]) && M(t) ? (n[i] = e(n[i], t)) : M(t) ? (n[i] = e({}, t)) : C(t) ? (n[i] = t.slice()) : (n[i] = t);
            },
            i = 0,
            a = arguments.length;
          i < a;
  ...
  function Se(e, t, r) {
    ...
    t = t || new FormData();
    var n = (r = ve.toFlatObject(r, { metaTokens: !0, dots: !1, indexes: !1 }, !1, function (e, t) {
        return !ve.isUndefined(t[e]);
      })).metaTokens,
      o = r.visitor || c,
      i = r.dots,
      a = r.indexes,
      s = (r.Blob || ('undefined' != typeof Blob && Blob)) && ve.isSpecCompliantForm(t);
    ...
    function u(e) {
      ...
      return ve.isArrayBuffer(e) || ve.isTypedArray(e) ? (s && 'function' == typeof Blob ? new Blob([e]) : Buffer.from(e)) : e;
    }
    function c(e, r, o) {
      var s = e;
      if (e && !o && 'object' === f(e))
        if (ve.endsWith(r, '{}')) (r = n ? r : r.slice(0, -2)), (e = JSON.stringify(e));
          ...
          return (
            ...
            s.forEach(function (e, n) {
              !ve.isUndefined(e) && null !== e && t.append(!0 === a ? Ee([r], n, i) : null === a ? r : r + '[]', u(e));
            }),
            !1
          );
    ...
    var l = [],
      p = Object.assign(Oe, { defaultVisitor: c, convertValue: u, isVisitable: ge });
        ...
        if (!ve.isUndefined(r)) {
          ...
          l.push(r),
            ve.forEach(r, function (r, i) {
              !0 === (!(ve.isUndefined(r) || null === r) && o.call(t, r, ve.isString(i) ? i.trim() : i, n, p)) &&
                e(r, n ? n.concat(i) : [i]);
            }),
            l.pop();
        }
  ...
  function je(e, t, r) {
    ...
    var o,
      i = r && r.serialize;
    if ((o = i ? i(t, r) : ve.isURLSearchParams(t) ? t.toString() : new Re(t, r).toString(n))) {
      var a = e.indexOf('#');
  ...
  var Ae = (function () {
    ...
    _e = ('object' === ('undefined' == typeof navigator ? 'undefined' : f(navigator)) && navigator) || void 0,
    Ce = Ne && (!_e || ['ReactNative', 'NativeScript', 'NS'].indexOf(_e.product) < 0),
      ...
      function (e, t) {
        ...
        if (i) {
          ...
          if ((r = ve.isFileList(e)) || n.indexOf('multipart/form-data') > -1) {
            ...
            return Se(r ? { 'files[]': e } : e, a && new a(), this.formSerializer);
          }
        }
        return i || o
  ...
  function We(e, t, r, n, o) {
    return ve.isFunction(n)
      ? n.call(this, t, r)
      : (o && (t = r), ve.isString(t) ? (ve.isString(n) ? -1 !== t.indexOf(n) : ve.isRegExp(n) ? n.test(t) : void 0) : void 0);
  }
  var Ke = (function (e, t) {
    function r(e) {
        ...
        [
          {
            ...
            value: function (e, t, r) {
              ...
              if (ve.isPlainObject(e) || e instanceof this.constructor) i(e, t);
              else if (ve.isString(e) && (e = e.trim()) && !/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(e.trim()))
                i(
                  (function (e) {
                    var t,
                      r,
                      ...
                      e &&
                        e.split('\n').forEach(function (e) {
                          (n = e.indexOf(':')),
                            ...
                            !t ||
                              (o[t] && Me[t]) ||
                              ('set-cookie' === t ? (o[t] ? o[t].push(r) : (o[t] = [r])) : (o[t] = o[t] ? o[t] + ', ' + r : r));
                        }),
                      o
                    );
                  })(e),
                ...
                try {
                  for (f.s(); !(u = f.n()).done; ) {
                    var l = u.value;
                    if (!ve.isArray(l)) throw TypeError('Object iterator must return a key-value pair');
                    c[(s = l[0])] = (a = c[s]) ? (ve.isArray(a) ? [].concat(g(a), [l[1]]) : [a, l[1]]) : l[1];
                  }
                } catch (e) {
                  f.e(e);
                } finally {
  ...
  var et = function (e, t) {
    ...
    nt = Be.hasStandardBrowserEnv
      ? (function (e, t) {
          return function (r) {
            return (r = new URL(r, Be.origin)), e.protocol === r.protocol && e.host === r.host && (t || e.port === r.port);
          };
  ...
  function st(e, t) {
    ...
    function o(e, t, r, o) {
      return ve.isUndefined(t) ? (ve.isUndefined(e) ? void 0 : n(void 0, e, 0, o)) : n(e, t, 0, o);
    }
    function i(e, t) {
  ...
  var ut,
    ...
    ft = function (e) {
      ...
      if (
        ...
        (n.url = je(it(n.baseURL, n.url, n.allowAbsoluteUrls), e.params, e.paramsSerializer)),
        c &&
          u.set('Authorization', 'Basic ' + btoa((c.username || '') + ':' + (c.password ? unescape(encodeURIComponent(c.password)) : ''))),
        ve.isFormData(o))
      )
          ...
          if (
            ...
            (v.ontimeout = function () {
              ...
              u.timeoutErrorMessage && (t = u.timeoutErrorMessage),
                r(new ye(t, n.clarifyTimeoutError ? ye.ETIMEDOUT : ye.ECONNABORTED, e, v)),
                (v = null);
            }),
            ...
            ve.isUndefined(u.withCredentials) || (v.withCredentials = !!u.withCredentials),
        ...
        var n,
          ...
          i = function (e) {
            if (!n) {
              ...
              o.abort(t instanceof ye ? t : new $e(t instanceof Error ? t.message : t));
            }
          },
          a =
            t &&
            setTimeout(function () {
              (a = null), i(new ye('timeout '.concat(t, ' of ms exceeded'), ye.ETIMEDOUT));
            }, t),
          s = function () {
            e &&
              (a && clearTimeout(a),
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 6:
                    ...
                    return (p = l.value), e.delegateYield(r(n(ht(p, o))), 't0', 9);
                  case 9:
                    (a = !1), (e.next = 4);
                    break;
                  case 12:
    ...
    mt = 'function' == typeof fetch && 'function' == typeof Request && 'function' == typeof Response,
            ...
            for (;;)
              switch ((e.prev = e.next)) {
                ...
                case 4:
                  ...
                  return (r = new Request(Be.origin, { method: 'POST', body: t })), (e.next = 8), r.arrayBuffer();
                case 8:
                case 15:
        ...
        u().mark(function e(t, r) {
          ...
          return u().wrap(function (e) {
            for (;;)
              switch ((e.prev = e.next)) {
                case 0:
                  return (n = ve.toFiniteNumber(t.getContentLength())), e.abrupt('return', null == n ? xt(r) : n);
                case 2:
                case 'end':
                  return e.stop();
              }
                  ...
                  switch ((e.prev = e.next)) {
                    ...
                    case 11:
                      ...
                      (S = new Request(n, { method: 'POST', body: i, duplex: 'half' })),
                        ve.isFormData(i) && (x = S.headers.get('content-type')) && d.setContentType(x),
                        S.body && ((R = tt(O, et(rt(p)))), (k = b(R, 2)), (T = k[0]), (j = k[1]), (i = yt(S.body, 65536, T, j)));
                    case 15:
                      return (
                    ...
                    case 20:
                      return (
                        ...
                        Ot &&
                          ...
                          (_ = ve.toFiniteNumber(P.headers.get('content-length'))),
                          (C = (l && tt(_, et(rt(l), !0))) || []),
                          (U = b(C, 2)),
                          (F = U[0]),
                          (B = U[1]),
                    ...
                    case 33:
                      if (
                        ...
                        (e.t2 = e.catch(4)),
                        E && E(),
                        !e.t2 || 'TypeError' !== e.t2.name || !/Load failed|fetch/i.test(e.t2.message))
                      ) {
                        e.next = 38;
                        break;
                      }
                      throw Object.assign(new ye('Network Error', ye.ERR_NETWORK, t, w), { cause: e.t2.cause || e.t2 });
                    case 38:
  ...
  var jt = function (e) {
    ...
    Pt = function (e) {
      for (var t, r, n = (e = ve.isArray(e) ? e : [e]).length, o = {}, i = 0; i < n; i++) {
        var a = void 0;
        if (((r = t = e[i]), !At(t) && void 0 === (r = Tt[(a = String(t)).toLowerCase()])))
  ...
  function Nt(e) {
    return (
      ...
      Pt(e.adapter || Ie.adapter)(e).then(
        function (t) {
          return Lt(e), (t.data = Ge.call(e, e.transformResponse, t)), (t.headers = Ve.from(t.headers)), t;
        },
        function (t) {
          return (
            Xe(t) ||
              ...
              t &&
                t.response &&
                ((t.response.data = Ge.call(e, e.transformResponse, t.response)), (t.response.headers = Ve.from(t.response.headers)))),
            Promise.reject(t)
          );
        },
      )
  ...
  (Ct.transitional = function (e, t, r) {
    ...
    return function (r, o, i) {
      ...
      return (
        t && !Ut[o] && ((Ut[o] = !0), console.warn(n(o, ' has been deprecated since v' + t + ' and will be removed in the near future'))),
        !e || e(r, o, i)
      );
    };
  }),
  ...
  var Ft = {
    ...
    Dt = (function () {
      function e(t) {
        d(this, e), (this.defaults = t || {}), (this.interceptors = { request: new Ae(), response: new Ae() });
      }
      var t;
      return (
        y(e, [
                        ...
                        switch ((e.prev = e.next)) {
                          ...
                          case 6:
                            if (((e.prev = 6), (e.t0 = e.catch(0)), e.t0 instanceof Error)) {
                              ...
                              try {
                                e.t0.stack
                                  ? o && !String(e.t0.stack).endsWith(o.replace(/^.+\n.+\n/, '')) && (e.t0.stack += '\n' + o)
                                  : (e.t0.stack = o);
                              } catch (e) {}
                            }
                            throw e.t0;
              ...
              void 0 !== n &&
                ...
                null != o &&
                  (ve.isFunction(o)
                    ...
                    : Ft.assertOptions(o, { encode: Bt.function, serialize: Bt.function }, !0)),
                void 0 !== t.allowAbsoluteUrls ||
                  (void 0 !== this.defaults.allowAbsoluteUrls
                    ? (t.allowAbsoluteUrls = this.defaults.allowAbsoluteUrls)
                    : (t.allowAbsoluteUrls = !0)),
                Ft.assertOptions(t, { baseUrl: Bt.spelling('baseURL'), withXsrfToken: Bt.spelling('withXSRFToken') }, !0),
                (t.method = (t.method || this.defaults.method || 'get').toLowerCase());
              var a = i && ve.merge(i.common, i[t.method]);
              i &&
                ve.forEach(['delete', 'get', 'head', 'post', 'put', 'patch', 'common'], function (e) {
                  delete i[e];
                }),
          ...
          },
          {
            key: 'getUri',
            value: function (e) {
              return je(it((e = st(this.defaults, e)).baseURL, e.url, e.allowAbsoluteUrls), e.params, e.paramsSerializer);
            },
          },
        ]),
        e
